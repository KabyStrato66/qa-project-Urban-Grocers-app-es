...
def test3_create_kit_without_name_success_response():
...
def test5_create_kit_has_special_symbol_in_name_success_response():
    current_kit_body = get_kit_body(data.test5_kit_name)
    positive_assert(current_kit_body)

def test6_create_kit_has_space_in_name_success_response():
    current_kit_body = get_kit_body(data.test6_kit_name)
    positive_assert(current_kit_body)

def test7_create_kit_has_number_in_name_success_response():
